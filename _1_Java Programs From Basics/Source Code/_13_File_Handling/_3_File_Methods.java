...
public class _3_File_Methods
{
    ...
    static void fileMethods() throws IOException
    {
        ...
        File file = new File("C:\\Users\\NANDANGN\\Desktop\\Learning Resources\\Java Notes With Important Examples\\_1_Java Programs From Basics\\Source Code\\_13_File_Handling\\Files","fileMethods");

        file.mkdir(); //creates directory
        System.out.println("Directory Existence? "+file.exists());

        //creates a file
        File newFile = new File("C:\\Users\\NANDANGN\\Desktop\\Learning Resources\\Java Notes With Important Examples\\_1_Java Programs From Basics\\Source Code\\_13_File_Handling\\Files\\fileMethods","fileMethods.txt");
